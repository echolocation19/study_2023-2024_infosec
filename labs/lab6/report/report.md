...
![контекст безопасности http](image/img2.png){ #fig:002 width=70% height=70%}
...
![переключатели SELinux для http](image/img3.png){ #fig:003 width=70% height=70%}
...
![создание html-файла и доступ по http](image/img4.png){ #fig:004 width=70% height=70%}
...
![ошибка доступа после изменения контекста](image/img5.png){ #fig:005 width=70% height=70%}
...
![лог ошибок](image/img6.png){ #fig:006 width=70% height=70%}
...
![переключение порта](image/img7.png){ #fig:007 width=70% height=70%}
...
![доступ по http на 81 порт](image/img8.png){ #fig:008 width=70% height=70%}
